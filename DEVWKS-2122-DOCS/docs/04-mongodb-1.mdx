...
This workshop uses a library called `Mongoose` to handle the database connection and performing database operations for us.
...
We have finished the MongoDb portion of the workshop. We will now start working with Passport and WebEx OAuth.
