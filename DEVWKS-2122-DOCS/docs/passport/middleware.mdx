...
We will create one more middle to make this possible. In the `middlewares` directory create a new file called `authorizedUser.js`. Then paste the below code into it:
